...
describe('Invoice Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('should call BankAccount query and add missing value', () => {
      const invoice: IInvoice = { id: 22583 };
      const bankAccount: IBankAccount = { id: 17167 };
      invoice.bankAccount = bankAccount;

      const bankAccountCollection: IBankAccount[] = [{ id: 17167 }];
  ...
  describe('Compare relationships', () => {
    describe('compareBankAccount', () => {
      it('should forward to bankAccountService', () => {
        const entity = { id: 17167 };
        const entity2 = { id: 18934 };
