...
class InvoiceResourceIT {
    ...
    private static final String DEFAULT_NUMBER = "INV-001";
    private static final String UPDATED_NUMBER = "INV-002";
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.number(UPDATED_NUMBER).status(UPDATED_STATUS);
        ...
        // Validate the Invoice in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedInvoiceToMatchUpdatableProperties(insertedInvoice);
    }
    ...
    void fullUpdateInvoiceWithPatch() throws Exception {
        ...
        // Validate the Invoice in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedInvoiceToMatchAllProperties(insertedInvoice);
    }
